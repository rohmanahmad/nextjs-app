...
export default function MobileLeftside() {
  function closeSideMenu(e) { }
  function togglePagesMenu(e) { }
  const isPagesMenuOpen = false
  const pageMenuTemplate = (
    <ul x-transitionenter="transition-all ease-in-out duration-300" x-transitionenterstart="opacity-25 max-h-0"
      x-transitionenterend="opacity-100 max-h-xl" x-transitionleave="transition-all ease-in-out duration-300"
      x-transitionleavestart="opacity-100 max-h-xl" x-transitionleaveend="opacity-0 max-h-0"
  ...
  return (
    <aside className="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
      x-show="isSideMenuOpen" x-transitionenter="transition ease-in-out duration-150"
      x-transitionenterstart="opacity-0 transform -translate-x-20" x-transitionenterend="opacity-100"
      x-transitionleave="transition ease-in-out duration-150" x-transitionleavestart="opacity-100"
      x-transitionleaveend="opacity-0 transform -translate-x-20" onClick={closeSideMenu} onKeyDown={closeSideMenu}>
      <div className="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
          ...
          <li className="relative px-6 py-3">
            ...
            {isPagesMenuOpen ? pageMenuTemplate : ''}
          </li>
        </ul>
